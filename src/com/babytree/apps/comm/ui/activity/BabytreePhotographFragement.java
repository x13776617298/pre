 ...
 * 
 */
public abstract class BabytreePhotographFragement extends BabyTreeFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mBitmapPath = BabytreeBitmapCache.getAppCacheDirectory(mContext) + "/tmpBitmap.jpg";
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case REQUEST_PHOTO_LIBRARY:
			...
			try {
				...
				i.setClass(mApplication, BabytreeModifyActivity.class);
		...
		case CAMERA_WITH_DATA:
			...
			try {
				...
				i2.setClass(mApplication, BabytreeModifyActivity.class);
...
//				finish();
	...
	private void setImageForUri(Uri uri) {
		...
		if (FolderOper.isExistSdcard(mContext)) {
			File toFile = new File(BabytreeBitmapCache.getAppCacheDirectory(mContext), getPhotoFilename(new Date()));
	...
	private void takePhoto() {
		...
		if (FolderOper.isExistSdcard(mContext)) {
			mImageFile = new File(BabytreeBitmapCache.getAppCacheDirectory(mContext), filename);
