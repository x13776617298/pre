 ...
 * 
 */
public abstract class UpAndDownRefreshActivity<T> extends BabytreeTitleAcitivty implements
	...
	protected void setListViewSelector(int resID) {
		if (mPullRefreshListView != null) {
			mPullRefreshListView.getRefreshableView().setSelector(resID);
		}
	}

	protected void setListViewSelector(Drawable sel) {
		if (mPullRefreshListView != null) {
			mPullRefreshListView.getRefreshableView().setSelector(sel);
		}
	}
	...
	final class DownRefreshAsyncTask extends BabytreeAsyncTask {
		...
		protected void success(DataResult result) {
			UpAndDownRefreshActivity.this.success(result);
			isFirstLoading = false;
		}

		@Override
		protected void failure(DataResult result) {
			UpAndDownRefreshActivity.this.failure(result);
		}
