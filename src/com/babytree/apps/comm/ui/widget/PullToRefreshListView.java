...
import com.babytree.apps.comm.ui.widget.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	protected final ListView createRefreshableView(Context context,
		...
		// lv.setDivider(getResources().getDrawable(R.drawable.driver));
		lv.setDrawSelectorOnTop(false);
		lv.setCacheColorHint(getResources().getColor(android.R.color.transparent));
		//lv.setSelector(getResources().getDrawable(R.drawable.list_selector_background));
