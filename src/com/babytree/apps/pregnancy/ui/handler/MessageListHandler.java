...
public class MessageListHandler implements AbstractDataLoaderHandler<Base>,
    ...
    public MessageListHandler(Activity activity, String loginString, MessageType type) {
        mActivity = activity;
...
//            }
            ...
            btnReload.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new FirstBackgroundTask(MessageListHandler.this).execute();
                }
            });
        } else if (status == REQUEST_FAILED) {
            // 错误处理
...
//            }
            ...
            btnReload.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new BackgroundTask(MessageListHandler.this).execute(mValues.size());
                }
            });
        }
    }
    ...
    public void refershTop(long timestamp) {
        new TopBackgroundTask(MessageListHandler.this).execute(timestamp);
    }
        ...
        protected AbstractDataResult<Base> doInBackground(Void... params) {
            ...
            try {
                if (com.babytree.apps.comm.util.BabytreeUtil.hasNetwork(mActivity)) {
                    pageNo = FIRST_START;
                    DataResult ret = P_BabytreeController.getUserMessageList(mLoginString, mType,
                            pageNo);
