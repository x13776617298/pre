...
public class DoctorTopicListHandler implements AbstractDataLoaderHandler<Base>,
	...
	private String mDoctorTag;
	private String mGroupId;

	public DoctorTopicListHandler(Activity activity, String doctorTag, String groupId, TextView txtmsg, String name) {
		mActivity = activity;
		mDoctorTag = doctorTag;
		mGroupId = groupId;
		mTxtMessage = txtmsg;
		mName = name;
	}
	...
	public void refersh(String groupId, String dctorTag) {
		mGroupId = groupId;
		mDoctorTag = dctorTag;
		mValues.clear();
		mCallback.clear();
	...
	public void refershTop(long timestamp) {
		new TopBackgroundTask(DoctorTopicListHandler.this).execute(timestamp);
	}
