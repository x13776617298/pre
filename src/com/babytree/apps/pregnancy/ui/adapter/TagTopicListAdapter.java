...
public class TagTopicListAdapter extends AbstractPageableAdapter<Base> {
	private BabytreeBitmapCache bitmapCache;// 缓存对象
	private Context mContext;

	private ArrayList<Base> values;

	public TagTopicListAdapter(PullToRefreshListView listView, Context context, int loadingViewResourceId,
