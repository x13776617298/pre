...
public class ForumHospitalAdapter extends AbstractPageableAdapter<Base> {
	private BabytreeBitmapCache bitmapCache;// 缓存对象
	private Context mContext;
	private ArrayList<Base> values;

	public ForumHospitalAdapter(PullToRefreshListView listView, Context context, int loadingViewResourceId,
