...
public class WeekTopicListAdapter extends AbstractPageableAdapter<Base> {
	private BabytreeBitmapCache bitmapCache;// 缓存对象
	private Context mContext;
	private ArrayList<Base> values;

	public WeekTopicListAdapter(PullToRefreshListView listView, Context context, int loadingViewResourceId,
